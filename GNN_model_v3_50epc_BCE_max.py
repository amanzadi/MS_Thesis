...
class PolypharmacyDataset(DGLDataset):
    ...
    def process(self):
        ...
        #drug2graph = {ind:label for ind, label in enumerate(self.labels)} 
...
f = open("log_model_V3_BCE_max.txt", "a")
f.write('\n======================== Trainig ========================\n')
...
torch.save(model.state_dict(), 'state_dict_model_V3_BCE_max.pt')
torch.save(model, 'entire_model_V3_BCE_max.pt')
print('\nmodel is saved!\n')
f.write('\nmodel saved!\n')
